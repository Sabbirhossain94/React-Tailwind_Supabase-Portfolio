        ...
        <div>
            <div className=' w-full mx-auto flex justify-center'>
                ...
                <div className='w-full ' style={{}} aria-live="polite">
                    ...
                    <button onClick={uploadImage} className='w-full mt-[15px] flex justify-center rounded-md border border-transparent bg-sky-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'>Upload</button>
