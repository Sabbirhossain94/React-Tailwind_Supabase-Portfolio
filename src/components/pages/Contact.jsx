...
export default function Contact({ funcTopNav, funcSideNav, }) {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_l0k9e43', 'template_d1na90m', form.current, '9ZJePhXgohfdxuU3G')
            .then((result) => {
                            ...
                            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                                <div className="relative shadow-xl">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-3">
                                        <div className="rounded-md relative overflow-hidden bg-gradient-to-b from-zinc-800 to-zinc-900 dark:from-slate-800 dark:to-slate-900 py-10 px-6 sm:px-10 xl:p-12">
                                            ...
                                            <dl className="mt-8 space-y-6">
                                                ...
                                                <dd className="flex text-base text-teal-50">
                                                    ...
                                                    <svg className="h-6 w-6 flex-shrink-0 text-sky-500 dark:text-cyan-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true">
                                                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                                                    </svg>
                                                    <span className="ml-3">+8801766651978</span>
                                                </dd>
                                            ...
                                            <ul role="list" className="mt-8 flex space-x-12">
                                                ...
                                                <li>
                                                    <a className="text-teal-200 hover:text-teal-100" href="https://github.com/Sabbirhossain94">
                                                        <span className="sr-only">GitHub</span>
                                                        <svg className="h-7 w-7 text-sky-500 dark:text-cyan-400" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                                ...
                                                <li>
                                                    <a className="text-teal-200 hover:text-teal-100" href="https://www.linkedin.com/in/sabbir-hossain-b73726214/">
                                        ...
                                        <div className="dark:bg-slate-800  py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                                            ...
                                            <form ref={form} onSubmit={sendEmail} className=" mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                                                <div>
                                                    ...
                                                    <div className="mt-1">
                                                        <input type="text" name="first_name" id="first_name" autoComplete="given-name" className="ring-1 dark:ring-cyan-500 mt-[10px]  dark:text-white block w-full rounded-md py-3 px-4 shadow-sm dark:bg-slate-800 focus:border-indigo-500 focus:ring-indigo-400" required />
                                                    </div>
                                                </div>
                                                <div>
                                                    <label htmlFor="last-name" className="text-warm-gray-900 block text-sm font-medium dark:text-white">Last name</label>
                                                    <div className="mt-1">
                                                        <input type="text" name="last_name" id="last_name" autoComplete="family-name" className="ring-1 dark:ring-cyan-500 mt-[10px] dark:text-white block w-full rounded-md py-3 px-4 shadow-sm dark:bg-slate-800" required />
                                                    </div>
                                                </div>
                                                <div>
                                                    <label htmlFor="email" className="text-warm-gray-900 block text-sm font-medium dark:text-white">Email</label>
                                                    <div className="mt-1">
                                                        <input id="email" name="email" type="email" autoComplete="email" className="ring-1 dark:ring-cyan-500 mt-[10px] dark:text-white block w-full rounded-md py-3 px-4 shadow-sm dark:bg-slate-800" required />
                                                    </div>
                                                </div>
                                                <div>
                                                    ...
                                                    <div className="mt-1">
                                                        <input type="tel" name="phone" id="phone" autoComplete="tel" className="ring-1 dark:ring-cyan-500 mt-[10px] dark:text-white block w-full rounded-md py-3 px-4 shadow-sm dark:bg-slate-800" aria-describedby="phone-optional" required />
                                                    </div>
                                                </div>
                                                <div className="sm:col-span-2">
                                                    <label htmlFor="subject" className="text-warm-gray-900 block text-sm font-medium dark:text-white">Subject</label>
                                                    <div className="mt-1">
                                                        <input type="text" name="subject" id="subject" className="ring-1 dark:ring-cyan-500 mt-[10px] dark:text-white block w-full rounded-md py-3 px-4 shadow-sm dark:bg-slate-800" required />
                                                    </div>
                                                </div>
                                                <div className="sm:col-span-2">
                                                    <div className="flex justify-between">
                                                    ...
                                                    <div className="mt-1">
                                                        <textarea id="message" name="message" rows="4" className="ring-1 dark:ring-cyan-500 mt-[10px] dark:text-white block w-full rounded-md py-3 px-4 shadow-sm dark:bg-slate-800" aria-describedby="message-max" required></textarea>
                                                    </div>
                                                </div>
                                                <div className="sm:col-span-2 sm:flex sm:justify-end">
                                                    <button type="submit" className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-sky-500 hover:bg-sky-700 dark:ring-cyan-500 dark:hover:bg-cyan-700 px-6 py-3 text-base font-medium text-white shadow-sm  focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 sm:w-auto">Submit</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
