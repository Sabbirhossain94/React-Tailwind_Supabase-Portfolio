                                            ...
                                            <ul role="list" className="mt-8 flex space-x-12">
                                                ...
                                                <li>
                                                    <a className="text-teal-200 hover:text-teal-100" href="https://github.com/Sabbirhossain94">
                                                        ...
                                                        <svg className="h-7 w-7 text-sky-500 dark:text-teal-500" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                        ...
                                        <div className="dark:bg-slate-800  py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                                            ...
                                            <form ref={form} onSubmit={sendEmail} className=" mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                                                ...
                                                <div className="sm:col-span-2">
                                                    ...
                                                    <div className="mt-1">
                                                        <textarea id="message" name="message" rows="4" className="ring-1 dark:ring-teal-500 mt-[10px] dark:text-white block w-full rounded-md py-3 px-4 shadow-sm dark:bg-slate-800" aria-describedby="message-max" required></textarea>
                                                    </div>
                                                </div>
                                                <div className="sm:col-span-2 sm:flex sm:justify-end">
                                                    <button type="submit" className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-sky-500 hover:bg-sky-700 dark:bg-teal-500 dark:hover:bg-teal-700 px-6 py-3 text-base font-medium text-white shadow-sm  focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 sm:w-auto">Submit</button>
                                                </div>
                                            </form>
                                        </div>
