                                    ...
                                    <div className="dark:bg-slate-800 py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                                        ...
                                        <form ref={form} onSubmit={sendEmail} className=" mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                                            <div>
                                                ...
                                                <div className="mt-1">
                                                    <input type="text" name="first_name" id="first_name" autoComplete="given-name" className="ring-1 mt-[10px] dark:text-white  block w-full rounded-md py-3 px-4 shadow-sm dark:bg-slate-800 focus:ring-indigo-400" required/>
                                                </div>
                                            </div>
                                            <div>
                                                <label htmlFor="last-name" className="text-warm-gray-900 block text-sm font-medium dark:text-white">Last name</label>
                                                <div className="mt-1">
                                                    <input type="text" name="last_name" id="last_name" autoComplete="family-name" className="ring-1 mt-[10px] dark:text-white block w-full rounded-md py-3 px-4 shadow-sm dark:bg-slate-800" required/>
                                                </div>
                                            </div>
                                            <div>
                                                <label htmlFor="email" className="text-warm-gray-900 block text-sm font-medium dark:text-white">Email</label>
                                                <div className="mt-1">
                                                    <input id="email" name="email" type="email" autoComplete="email" className="ring-1  mt-[10px] dark:text-white block w-full rounded-md py-3 px-4 shadow-sm dark:bg-slate-800" required/>
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <div className="mt-1">
                                                    <input type="tel" name="phone" id="phone" autoComplete="tel" className="ring-1 mt-[10px] dark:text-white block w-full rounded-md py-3 px-4 shadow-sm dark:bg-slate-800" aria-describedby="phone-optional" required/>
                                                </div>
                                            </div>
                                            <div className="sm:col-span-2">
                                                <label htmlFor="subject" className="text-warm-gray-900 block text-sm font-medium dark:text-white">Subject</label>
                                                <div className="mt-1">
                                                    <input type="text" name="subject" id="subject" className="ring-1  mt-[10px] dark:text-white block w-full rounded-md py-3 px-4 shadow-sm dark:bg-slate-800" required/>
                                                </div>
                                            </div>
                                            <div className="sm:col-span-2">
                                                <div className="flex justify-between">
                                                ...
                                                <div className="mt-1">
                                                    <textarea id="message" name="message" rows="4" className="ring-1  mt-[10px] dark:text-white block w-full rounded-md py-3 px-4 shadow-sm dark:bg-slate-800" aria-describedby="message-max" required></textarea>
                                                </div>
                                            </div>
