      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-10 xl:px-24">
        <div className="flex flex-col items-center">
          ...
          <div className="mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-10">
            <div
              data-aos="fade-right"
              className="relative border dark:border-zinc-700/90 rounded-xl col-span-1 w-96 md:w-80 lg:w-72 xl:w-80 h-96 flex flex-1 flex-col justify-center items-center">
            ...
            <div
              data-aos="fade-up"
              className="relative border dark:border-zinc-700/90 rounded-xl col-span-1 w-96 md:w-80 lg:w-72 xl:w-80 h-96 flex flex-col justify-center items-center">
