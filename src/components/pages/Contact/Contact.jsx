            ...
            <div className=" mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="relative ">
                <div className="grid grid-cols-1 lg:grid-cols-3">
                  {/* left section */}
                    <div data-aos="fade-right" className="rounded-md relative overflow-hidden bg-zinc-200/30 dark:bg-slate-900/30 py-10 px-6 sm:px-10 xl:p-12">
                  ...
                  {/* Contact form ,right section */}
                    <div data-aos="fade-left" className="dark:bg-slate-800  py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
