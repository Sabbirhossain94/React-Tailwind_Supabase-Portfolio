        ...
        <div className="mx-auto grid grid-cols-1 grid-rows-3 gap-y-12 lg:grid lg:grid-cols-3 lg:grid-rows-1 gap-x-8">
          <div className="py-4 shadow-lg relative border dark:border-zinc-700/90 rounded-xl h-64 w-64 md:h-80 md:w-80 flex flex-col items-center ">
            ...
            <div className="flex justify-center items-center">
              <span className="absolute top-[190px] dark:text-white">Web Design</span>
            </div>
          </div>
          <div className="py-4 shadow-lg relative border dark:border-zinc-700/90 rounded-xl h-64 w-64 md:h-80 md:w-80 flex flex-col items-center ">
            <Frontend />
            <div className="flex justify-center items-center">
              <span className="absolute top-[190px] dark:text-white">Frontend Development</span>
            </div>
          </div>
          <div className="py-4 shadow-lg relative border dark:border-zinc-700/90 rounded-xl h-64 w-64 md:h-80 md:w-80 flex flex-col items-center ">
            <FullStack />
            <div className="flex justify-center items-center">
              <span className="absolute top-[190px] dark:text-white">Full Stack Development</span>
            </div>
          </div>
        </div>
      </div>
