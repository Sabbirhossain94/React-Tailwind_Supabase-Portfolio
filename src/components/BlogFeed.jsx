    ...
    return (
        <div>
            <TransitionGroup className="flex flex-col gap-16">
                    ...
                    >
                        <li key={item.id} className="list-none">
                            <article className=" group relative flex flex-col items-start">
                                ...
                                <div className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400" dangerouslySetInnerHTML={{ __html: item.content.substring(0, 20) }} />
                ...
                {allBlog.length > 3 ? (<button onClick={multipleFunc} className="inline-flex items-center gap-2 justify-center rounded-md py-2 px-3 text-sm outline-offset-2 transition active:transition-none bg-zinc-50 font-medium text-zinc-900 hover:bg-zinc-100 active:bg-zinc-100 active:text-zinc-900/60 dark:bg-zinc-800/50 dark:text-zinc-300 dark:hover:bg-zinc-800 dark:hover:text-zinc-50 dark:active:bg-zinc-800/50 dark:active:text-zinc-50/70 group mt-6 w-full" href="/#">Show More<svg viewBox="0 0 16 16" fill="none" aria-hidden="true" className="h-4 w-4 stroke-zinc-400 transition group-active:stroke-zinc-600 dark:group-hover:stroke-zinc-50 dark:group-active:stroke-zinc-50">
