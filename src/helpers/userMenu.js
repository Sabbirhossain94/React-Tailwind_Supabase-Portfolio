...
export const menuItems = (session, handleDashboard) => [
    {
        label: (
            <div className="font-sans flex flex-col justify-center items-center">
                <p className="font-sans font-medium flex items-center gap-2 rounded-md text-sm outline-offset-2 transition duration-300 hover:text-sky-400 dark:hover:text-teal-500 group">
                    Signed in as
                </p>
    ...
    {
        label: (
            <button className="font-sans flex items-center gap-2 rounded-md text-md outline-offset-2 transition duration-300 font-medium text-zinc-900 hover:text-sky-400 dark:hover:text-teal-500 group">
